...
let imagenes = [
    { imagen: "./componentes/Tarea Rutas/media/impresora.jpg", alt: "Foto de una impresora" },
    { imagen: "/componentes/Tarea Rutas/media/monitor.png", alt: "Imagen de un monitor" },
    { imagen: "/componentes/Tarea Rutas/media/raton.jpeg", alt: "Imagen de un ratón" },
    { imagen: "/componentes/Tarea Rutas/media/teclado.jpg", alt: "Imagen de un teclado" },
    { imagen: "/componentes/Tarea Rutas/media/usb.jpg", alt: "Imagen de un dispositivo USB." },
  ];
let imagen = '';
let texto = '';
let alt = '';
